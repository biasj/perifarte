...
public class ObraDao {
     public void addObra(Obra obr, int idOrg, int idArt) throws SQLException {
        ...
        String sql = "INSERT INTO obra (obra_titulo, obra_organizacao_id, obra_artista_id, obra_preco, obra_descricao) VALUES (?,?,?,?,?)";
        ...
        try (Connection conn = Conexao.obterConexao()) {
            ...
            try (PreparedStatement stmt = conn.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
                ...
                stmt.setInt(2, idOrg);
                stmt.setInt(3, idArt);
                stmt.setBigDecimal(4, obr.getPreco());
                stmt.setString(5, obr.getDescricao());
